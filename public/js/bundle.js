        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            showAlert = function showAlert(type, msg) {
              ...
              var markup = "<div class=\"alert alert--".concat(type, "\" style=\"display:block;margin:auto;height:14%;background-color:").concat(color, ";\">").concat(msg, "</div>");
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password, confirm_password) {
    var hideAlert, showAlert, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js"}],"addNotifications.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addNotifications = void 0;
...
var addNotifications = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, duration) {
    var hideAlert, showAlert, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function addNotifications(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(currentPassword, newPassword, newConfirmPassword) {
    var hideAlert, showAlert, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js"}],"ForgotPassword.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js"}],"SaveForgotResetPassword.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.saveForgotPassword = void 0;
...
var saveForgotPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(newPassword, confirmPassword, token) {
    var hideAlert, showAlert, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/resetPassword/:".concat(token),
              data: {
                newPassword: newPassword,
  ...
  return function saveForgotPassword(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.saveForgotPassword = saveForgotPassword;
...
var _addNotifications = require("./addNotifications");

var _updatePassword = require("./updatePassword.js");

var _ForgotPassword = require("./ForgotPassword.js");

var _SaveForgotResetPassword = require("./SaveForgotResetPassword.js");
...
var signUpBtn = document.getElementById('form-register');
...
var sendResetLink = document.getElementById("send-forgot-reset-link");
var saveForgottenResetBtn = document.getElementById("Forgot-Reset-Btn");
...
if (notifyMeBtn) notifyMeBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var url = document.getElementById("url").value;
  var duration = document.getElementById("duration").value;
  (0, _addNotifications.addNotifications)(url, duration); //setTimeout(AddNotifications,10000);
});
...
if (resetBtn) resetBtn.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var currentPassword, newPassword, newConfirmPassword;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            newConfirmPassword = document.getElementById("confirmNewPassword").value; //alert(currentPassword);

            _context.next = 6;
            return (0, _updatePassword.resetPassword)(currentPassword, newPassword, newConfirmPassword);
...
if (sendResetLink) sendResetLink.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault(); //alert("hyeeeeee");

            email = document.getElementById("forgot-email").value; // alert(email);
...
if (saveForgottenResetBtn) {
  saveForgottenResetBtn.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var newPassword, confirmForgotPassword;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              e.preventDefault();
              newPassword = document.getElementById("newForgotPassword").value;
              confirmForgotPassword = document.getElementById("confirmForgotPassword").value; //alert(window.location.href.split("resetPassword/")[1]);

              _context3.next = 5;
              return (0, _SaveForgotResetPassword.saveForgotPassword)(newPassword, confirmForgotPassword, window.location.href.split("resetPassword/")[1]);
